        ...
        <div class="uTopTitlt">
            <div>
                <div id="container">
                    <img
                        id="selectfiles"
                        :src="PicLicenceImg ? PicLicenceImg : touUrl"
                        alt
                    />
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            touUrl: require('@/assets/checklist/sgdw.png')
        };
    },
    created() {},
    mounted() {
        this.PicLicenceImg = this.licenceImg;
        this.initPlUploader();
    },
    methods: {
        get_signature() {
            const _this = this;
            _this.$axios
                .post('https://newxiezhu.zzdingyun.com/ossapi/sign/get', {
                ...
                init: {
                    ...
                    FileUploaded: function (up, file, info) {
                        if (info.status == 200) {
                            ...
                            _this.PicUpImgList = _this.get_uploaded_object_name(
                                file.name
                            );
                            // let len = _this.PicUpImgList.length;

                            _this.PicLicenceImg =
                                hostUp + '/' + _this.PicUpImgList;

                            _this.$emit(
                                'listenToChildEvent',
                                _this.PicLicenceImg
                            );
                            console.log('14++' + _this.PicLicenceImg);
