            ...
            >
                <div class="cDrawerContent">
                    <el-form
                        ...
                        label-width="130px"
                    >
                        <el-form-item label="安全标题：" prop="sgtitle">
                            <el-input
                                v-model="fDrawerForm.sgtitle"
                                placeholder="请输入安全标题"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="安全等级：" prop="jibie">
                            <el-select
                        ...
                        <el-form-item label="安全金额：" prop="money">
                            <el-input-number
                        ...
                        <el-form-item label="安全详情：" prop="sgcontent">
                            <el-input
                                type="textarea"
                ...
                >
                    ...
                    <el-form-item>
                        <el-button
                            ...
                            >保存</el-button
                        >
                        <el-button @click="titleCancel('addEditForm')"
                            >取消</el-button
                        >
                    </el-form-item>
                </el-form>
    ...
    methods: {
        ...
        deleteTitleClick(list, type) {
            this.$axios
                ...
                .then((res) => {
                    if (res.data.code == 200) {
                        if (type == 1) {
                            this.AbasicList.splice(
                                this.AbasicList.indexOf(list),
                                1
                            );
                        } else if (type == 2) {
        ...
        getBasicList() {
            this.$axios
                ...
                .then((res) => {
                    if (res.data.code == 200) {
                        this.AbasicList = res.data.content.c;
                        this.BbasicList = res.data.content.d;
                    } else {
                    }
                })
                .catch(function (error) {
            ...
            _this.$refs[formName].validate((valid) => {
                if (valid) {
                    if (_this.fDrawerForm.spuser.length > 0) {
                        _this.$axios
                            .post('/task/CreatedAnQuan', _this.fDrawerForm)
                            .then((res) => {
                                if (res.data.code == 200) {
                                    _this.getList();
                                    _this.loading = false;
    ...
    watch: {
        projectData: {
            handler(newVal, oldVal) {
                //你需要执行的代码
                if (newVal.ppower == '2') {
                    this.$router.push({ path: '/project/projectError2' });
                }
                if (oldVal) {
                    this.getList();
                    this.getNextProject();
