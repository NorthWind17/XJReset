...
const routes = [
    ...
    //-----------首页
    {
        path: '/home',
        name: 'home',
        component: () => import('../pages/home.vue'),redirect: 'workbench'
    },
    {
        path: '/workbench',
        name: 'workbench',
    ...
    //---------------公司用户信息
    {
        ...
        children: [
            ...
            },
            {
                path: 'taskMouldSet',
                name: 'taskMouldSet',
                component: () => import('../pages/application/taskMouldSet.vue')
            },
            {
    ...
    //-----------资料路由
    {
        ...
        children: [
            {
                path: 'filesCurrent',
                component: () => import('../pages/file/filesCurrent.vue')
            },
            {
                path: 'filesBack',
            ...
            {
                path: 'filesDynamic',
                component: () => import('../pages/file/filesDynamic.vue'),
                name: 'filesDynamic'
            },
            {
                path: 'filesImg',
        ...
        children: [
            {
                path: 'projectPanel',
                name: 'projectPanel',
                component: () => import('../pages/project/projectPanel.vue')
            },
            {
                path: 'projectInfo',
                name: 'projectInfo',
            ...
            },
            {
                ...
                component: () => import('../pages/project/projectProgress.vue')
            },
            {
                path: 'projectQuality',
                name: 'projectQuality',
                component: () => import('../pages/project/projectQuality.vue')
            },
            {
                path: 'projectSafe',
                name: 'projectSafe',
                component: () => import('../pages/project/projectSafe.vue')
            },
            {
                path: 'projectCost',
                name: 'projectCost',
                component: () => import('../pages/project/projectCost.vue')
            },
            {
                path: 'projectContract',
                name: 'projectContract',
                component: () => import('../pages/project/projectContract.vue')
            },
            {
                path: 'projectError1',
                name: 'projectError1',
                component: () => import('../pages/project/projectError.vue')
            },
            {
                path: 'projectError2',
                name: 'projectError2',
    ...
    //---------任务路由
    {
        ...
        children: [
            ...
            {
                path: 'taskManyList',
                component: () => import('../pages/task/taskManyList.vue'),
                name: 'taskManyList',
                meta: {
                    title: 'taskManyList',
                    icon: '',
    ...
    //----------日志路由
    {
        ...
        children: [
            ...
            },
            {
                path: 'diaryPrintList',
                name: 'diaryPrintList',
                component: () => import('../pages/diary/diaryPrintList.vue')
            },
            {
                path: 'diaryAdd',
                name: 'diaryAdd',
