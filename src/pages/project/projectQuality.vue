            ...
            >
                <div class="cDrawerContent">
                    <el-form
                        ...
                        label-width="130px"
                    >
                        <el-form-item label="事故标题：" prop="sgtitle">
                            <el-input
                                v-model="fDrawerForm.sgtitle"
                                placeholder="请输入事故标题"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="事故等级：" prop="jibie">
                            <el-select
                        ...
                        <el-form-item label="事故金额：" prop="money">
                            <el-input-number
                        ...
                        <el-form-item label="事故详情：" prop="sgcontent">
                            <el-input
                                type="textarea"
    ...
    watch: {
        projectData: {
            handler(newVal, oldVal) {
                //你需要执行的代码
                if (newVal.ppower == '2') {
                    this.$router.push({ path: '/project/projectError1' });
                }
                if (oldVal) {
                    this.getList();
                    this.getNextProject();
